  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the convenience and satisfaction with Delivery Hero, your reliable partner in food delivery system that brings your favorite meals right at your doorstep"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1695653422872-9bd1e29fe490?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxmb29kJTIwZGVsaXZlcnl8ZW58MHx8fHwxNjk2NDc1NDcwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@grab?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Grab`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the convenience and satisfaction with Delivery Hero, your reliable partner in food delivery system that brings your favorite meals right at your doorstep`}
            </Text>
            <Box
