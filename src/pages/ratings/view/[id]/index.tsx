            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('rating', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/ratings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Rating Rating" text={data?.rating_rating} />

                <FormListItem label="Review" text={data?.review} />
