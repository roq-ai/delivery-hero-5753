...
import { getCustomerProfileById } from 'apiSdk/customer-profiles';
...
function CustomerProfileViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CustomerProfileInterface>(
    () => (id ? `/customer-profiles/${id}` : null),
    () =>
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('customer_profile', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/customer-profiles/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Preferred Cuisine" text={data?.preferred_cuisine} />
