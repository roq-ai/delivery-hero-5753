...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Reservation #456 has been made by Jane Doe.create': {
    roles: ['restaurant-manager'],
    key: 'reservation_create',
    tenantPath: [],
    userPath: [],
  },
  'Feedback #789 has been received from John Doe.create': {
    roles: ['restaurant-manager'],
    key: 'feedback_create',
    tenantPath: [],
    userPath: [],
...
const ownerRoles: string[] = ['restaurant-manager'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['restaurant-manager'];
